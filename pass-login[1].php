...
//       $stmt=$mysqli->prepare("SELECT pass_email ,pass_pwd , pass_id FROM user WHERE pass_email=$pass_email and pass_pwd=$pass_pwd");//sql to log in user
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="image/logopng.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
